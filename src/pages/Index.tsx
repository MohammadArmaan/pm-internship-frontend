    ...
    const features = [
        {
            ...
            description:
                "Explore internships across technology, healthcare, education, and more sectors.",
        },
        {
            icon: GraduationCap,
            title: "Skill Development",
            description:
                "Gain practical experience and industry-relevant skills from leading organizations.",
        },
        {
            icon: Star,
            title: "AI-Powered Matching",
            description:
                "Get personalized internship recommendations based on your profile and interests.",
        },
        {
            icon: TrendingUp,
            title: "Career Growth",
    ...
    return (
        <div className="min-h-screen bg-background">
            ...
            <section className="relative overflow-hidden ps-5 md:ps-0 pt-20 pb-16 md:pt-28 md:pb-24">
                <div className="absolute inset-0 bg-gradient-to-br from-orange-400/25 via-white/8 via-50% to-green-600/25 opacity-40 pointer-events-none"></div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            ...
                            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
                                Empowering India's youth with world-class
                                internship opportunities. Connect with leading
                                organizations and build the skills that shape
                                our nation's future.
                            </p>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                            Discover opportunities that match your passion and
                            accelerate your career growth with India's premier
                            internship program.
                        </p>
                    </motion.div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    ...
                    >
                        ...
                        <p className="text-xl mb-8 opacity-90">
                            Join thousands of young Indians who are building
                            their careers through the PM Internship Scheme.
                        </p>
                        <Button
                            variant="secondary"
                            asChild
